        ...
        <div className="p-6 lg:p-8 space-y-8 max-w-7xl mx-auto animate-pulse">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2 space-y-6">
              <div className="w-full h-80 bg-card-secondary/60 rounded-2xl"></div>
              <div className="h-8 bg-card-secondary/60 rounded w-1/2"></div>
              <div className="h-4 bg-card-secondary/60 rounded w-full"></div>
            </div>
            <div className="space-y-6">
              <div className="h-40 bg-card-secondary/60 rounded-2xl"></div>
              <div className="h-80 bg-card-secondary/60 rounded-2xl"></div>
            </div>
          </div>
        </div>
      </DashboardLayout>
          ...
          <div className="flex justify-center gap-3 pt-4">
            ...
            {error && (
              <button
                ...
                className="px-4 py-2 bg-accent hover:bg-accent/90 text-gray-900 text-xs font-bold rounded-lg uppercase tracking-wider transition-all"
              >
                Retry
              </button>
            )}
    ...
    <DashboardLayout>
      <div className="p-6 lg:p-8 space-y-6 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border pb-4">
          ...
          <nav className="flex items-center gap-2 text-[10px] text-muted font-bold uppercase tracking-widest">
            <Link href="/dashboard" className="hover:text-accent transition-colors">
              Dashboard
            </Link>
            <span>&gt;</span>
            <span className="text-muted">Workout Details</span>
          </nav>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-card border border-border p-6 rounded-2xl shadow-xl space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4 text-xs font-semibold font-mono">
                <div>
                  <span className="block text-[10px] text-muted uppercase tracking-widest mb-1">
                    Difficulty
                  </span>
                  <span className="inline-flex px-2.5 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider bg-accent/10 text-accent border border-yellow-500/20">
                    {workout.difficulty}
                  </span>
                </div>
                ...
                <div>
                  ...
                  <span className="text-foreground text-sm">⏱️ {workout.duration} Mins</span>
                </div>
                ...
                <div>
                  ...
                  <span className="text-foreground text-sm">✨ {workout.xpReward} XP</span>
                </div>
                ...
                <div>
                  ...
                  <span className="text-foreground text-sm">🪙 {workout.coinReward} Coins</span>
                </div>
              ...
              <button
                ...
                className="w-full py-3 bg-accent hover:bg-accent/90 text-gray-900 text-xs font-bold rounded-xl uppercase tracking-widest transition-all hover:scale-[1.02] shadow-lg shadow-accent/10 hover:shadow-accent/20 cursor-pointer"
              >
                Start Workout
              </button>
            </div>
