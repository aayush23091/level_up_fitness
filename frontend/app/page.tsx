    ...
    <div className="min-h-screen bg-[#0B0B0D]">
      ...
      <main className="pt-20">
        <section className="relative min-h-screen flex items-center overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-[#0B0B0D] via-[#121214] to-[#0B0B0D]"></div>
          <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-yellow-400/5 rounded-full blur-3xl"></div>
          <div className="absolute bottom-1/4 left-1/4 w-64 h-64 bg-yellow-400/3 rounded-full blur-3xl"></div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              <div className="space-y-8">
                ...
                <h1 className="text-5xl lg:text-7xl font-black text-white leading-tight">
                  Level up your{" "}
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-600 drop-shadow-[0_0_30px_rgba(250,204,21,0.3)]">
                    fitness
                  </span>{" "}
                  journey
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <Link
                    href="#workouts"
                    className="px-8 py-4 border border-yellow-400/30 text-yellow-400 font-semibold rounded-full hover:bg-yellow-400/10 transition-all text-center"
                  >
                    View Programs
                  </Link>
                </div>
                  ...
                  <div className="relative space-y-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-white font-bold text-lg">Strength Building</p>
                      </div>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="h-2 bg-white/10 rounded-full overflow-hidden">
                          <div className="h-full bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-full" style={{ width: "78%" }}></div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="h-2 bg-white/10 rounded-full overflow-hidden">
                          <div className="h-full bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-full" style={{ width: "65%" }}></div>
                        </div>
                      </div>
                    </div>
        ...
        <section id="workouts" className="py-24 lg:py-32 relative">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 hover:border-yellow-400/30 transition-all group">
                <div className="w-12 h-12 rounded-xl bg-yellow-400/20 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                  <span className="text-2xl">⚡</span>
                </div>
                <p className="text-gray-400 text-sm mb-2">XP Progression</p>
                <p className="text-4xl font-black text-yellow-400">2,450</p>
                <p className="text-gray-500 text-xs mt-2">Total XP earned</p>
              </div>
              ...
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 hover:border-yellow-400/30 transition-all group">
                ...
                <p className="text-gray-500 text-xs mt-2">Elite Athlete</p>
              </div>
              ...
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 hover:border-yellow-400/30 transition-all group">
                ...
                <p className="text-gray-400 text-sm mb-2">Daily Streak</p>
                <p className="text-4xl font-black text-yellow-400">5</p>
                <p className="text-gray-500 text-xs mt-2">Days active</p>
              </div>
              ...
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 hover:border-yellow-400/30 transition-all group">
                ...
                <p className="text-4xl font-black text-yellow-400">8</p>
                <p className="text-gray-500 text-xs mt-2">Achievements</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 lg:py-32 relative overflow-hidden">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">Track your progress with detailed metrics and insights.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-white font-semibold text-lg mb-1">AI Workout Coach</h3>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-white font-semibold text-lg mb-1">Smart Community Challenges</h3>
                      <p className="text-gray-400">Compete with friends and join global fitness challenges.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">Custom workout plans tailored to your goals.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative">
                <div className="relative bg-gradient-to-br from-[#121214] to-[#0B0B0D] border border-white/10 rounded-3xl p-6 shadow-2xl">
                  <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-t-3xl"></div>
                  
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <span className="text-gray-400 text-sm">Today's Progress</span>
                      <span className="text-yellow-400 font-semibold">77%</span>
                    </div>

                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-white/5 rounded-xl p-4">
                        <p className="text-gray-400 text-xs mb-1">Calories</p>
                        <p className="text-white font-bold text-2xl">620</p>
                        <p className="text-gray-500 text-xs">kcal burned</p>
                      </div>
                      <div className="bg-white/5 rounded-xl p-4">
                    ...
                    <div className="bg-white/5 rounded-xl p-4">
                      <p className="text-gray-400 text-xs mb-2">Weekly Activity</p>
                            ...
                            <div className="h-20 bg-white/5 rounded-lg relative overflow-hidden">
                              <div
                                className={`absolute bottom-0 left-0 right-0 rounded-t-lg transition-all ${
                                  value > 0 ? "bg-gradient-to-t from-yellow-600 to-yellow-400" : "bg-transparent"
                                }`}
                                style={{ height: `${value}%` }}
                              ></div>
                            </div>
        ...
        <section className="py-24 lg:py-32 bg-gradient-to-b from-[#0B0B0D] to-[#121214]">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
              <div>
                <p className="text-5xl lg:text-6xl font-black text-yellow-400 mb-2">500K+</p>
                <p className="text-gray-400">Active Users</p>
              </div>
              <div>
                <p className="text-5xl lg:text-6xl font-black text-yellow-400 mb-2">12M+</p>
                <p className="text-gray-400">Workouts Completed</p>
              </div>
              <div>
                <p className="text-5xl lg:text-6xl font-black text-yellow-400 mb-2">98%</p>
                <p className="text-gray-400">Success Rate</p>
              </div>
              <div>
                <p className="text-5xl lg:text-6xl font-black text-yellow-400 mb-2">4.9/5</p>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
              <div>
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-white font-bold">LevelUp Fitness</span>
                </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-400">
                  ...
                  <li><Link href="#" className="hover:text-yellow-400 transition-colors">Press</Link></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-400">
                  <li><Link href="#workouts" className="hover:text-yellow-400 transition-colors">Workouts</Link></li>
