    ...
    <div className="min-h-screen bg-gradient-to-br from-[#181818] to-[#232323] flex flex-col">
      <header className="w-full flex justify-between items-center px-8 py-6 border-b border-[#333]">
        <div>
          ...
          <p className="text-sm text-gray-400">App Dashboard</p>
        </div>
        <button
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-yellow-500/10 to-yellow-600/10 rounded-lg p-6 border border-yellow-500/30">
                ...
                <p className="text-gray-300">
                  This is a dummy dashboard route. Replace this with real fitness/pro-coach features.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                <a
                  href="#"
                  className="bg-yellow-400 hover:bg-yellow-500 text-black font-semibold py-3 px-6 rounded-lg text-center transition-colors"
                >
                  View Profile
                </a>
                <a
                  href="#"
                  className="bg-[#333] hover:bg-[#444] text-white font-semibold py-3 px-6 rounded-lg text-center transition-colors"
                >
                  Settings
                </a>
              </div>
